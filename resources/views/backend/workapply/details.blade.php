    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Applicant Details</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Applicant Details</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body py-3">
                            ...
                            <div class="table-responsive">
                                <!--begin::Table-->
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" class="data-table" style="width:100%;font-size:14px" >
                                    <!--begin::Table head-->
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" class="data-table" style="width:100%;font-size:14px" >
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">Result</th>
                                            <th class="min-w-140px">Marksheet</th>
                                            
                                            
                                        </tr>
                                    </thead>
                                    <tbody class="text-center">
                                        @if($data->education_information !=null)
                                        @foreach(json_decode($data->education_information) as $datas)
                                        <tr>
                                            <td>{{ $datas->exam_type }}</td>
                                            <td>{{ $datas->result }}</td>
                                            
                                            <td><a target="_blank" href="{{ url('updatecore/public/uploads/'.$datas->marksheet) }}" class="btn-sm btn-success">Click here</a></td>
                 ...
                 <div class="col-md-4">
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="table-responsive">
                                @if($data->cv !=null)
                                <a target="_blank" href="{{ url('updatecore/public/'.$data->cv) }}" class="btn-sm btn-success">Click here</a>
                                @else
                                  <a href="#" class="btn-sm btn-danger">NOT UPLOADED</a>
                                @endif
                            </div>
                            <!--end::Table container-->
                        </div>
                 ...
                 <div class="col-md-4">
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="table-responsive">
                                 ...
                                 <a target="_blank" href="{{ url('updatecore/public/'.$data->photo_id) }}" class="btn-sm btn-success">Click here</a>
                                @else
                                  <a href="#" class="btn-sm btn-danger">NOT UPLOADED</a>
                                @endif
                            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="table-responsive">
                                  @if($data->dbs !=null)
                                <a target="_blank" href="{{ url('updatecore/public/'.$data->dbs) }}" class="btn-sm btn-success">Click here</a>
                                @else
                                  <a href="#" class="btn-sm btn-danger">NOT UPLOADED</a>
                                @endif
                            </div>
