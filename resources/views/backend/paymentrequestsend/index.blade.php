                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('/admin/tutor/paymentrequest-history/'.$data->Tutor->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fas fa-eye blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('/admin/payment-request/delete/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
