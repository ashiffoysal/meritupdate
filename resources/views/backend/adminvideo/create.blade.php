...
@section('title', 'Create Admin Video')
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Admin Video</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Create Admin Video</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header card-header-stretch overflow-auto row text-right">
                           ...
                           <div class="mt-5" style="margin-left: 75px">
                                    <a href="{{ route('admin.adminvideo.index') }}" class="btn btn-primary">All Admin Video</a>
                                </div>
                           </div>
                        </div>
                        <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.adminvideo.create') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="title" placeholder="Enter Title">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   <select name="maincate" id="maincate" class="form-select form-select-solid" onchange="mainCateChange(this)">
                                                       @php
                                                            ...
                                                            $allMainCate=DB::table('video_main_category')->get();
                                                        
                                                       @endphp
                                                       <option selected disabled>Select</option>
                                                       @foreach($allMainCate as $mainCate)
                                    <option value="{{ $mainCate->id}}">{{ $mainCate->name}}</option>
                                    @endforeach
                                    ...
                                    <div class="row mb-10" style="display:none" id="admin_section">
                                    ...
                                    @foreach($allAdmin as $admins)
                                     ...
                                     <div class="row mb-10" style="display:none" id="tutor_section">
                                            <label class="col-lg-3 col-form-label text-lg-end">For Tutor:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   <select name="tutor_id" class="form-select form-select-solid">
                                        <option selected disabled>Select</option>
                                    <option value="0">All Tutor</option>
                                    @php
                                        $allTutor=DB::table('users')->where('is_deleted',0)->where('user_type',2)->where('for_branch_tutor',1)->get();
                                    @endphp
                                    @foreach($allTutor as $tutors)
                                     <option value="{{ $tutors->id }}">{{ $tutors->name }}</option>
                                     @endforeach
                                                   </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="total_time" placeholder="Enter total time (s)" = required>
                                    ...
                                    <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="file" name="file" placeholder="Enter fFile" accept="video/*" required>
