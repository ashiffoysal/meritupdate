...
@section('meta_description','Join expert-led A-Level Chemistry revision courses at Merit Tutors. Boost grades, understand complex topics, and succeed in your exams. Enroll today!')
@section('content')
    <style>
        .myTitle {
                    ...
                    <div class="banner_section">
                        <div class="banner_left">
                            <div class="banner_left_contents">
                                <span class="banner_span">A Level Chemistry Revision Course</span>
                                <h1 class="myTitle">A Level Chemistry Booster <span> Course </span> <br>– Targeted
                                ...
                                <p>Our A Level Chemistry revision course is designed for Year 12 and Year 13 pupils preparing
                                    for A Level Chemistry exam.
                    ...
                    <div class="our_service">
                        <div class="default_title">
                            <div class="default_title_left">
                                <h2>A Level <span>Chemistry Topics <img
                    ...
                    <div class="our_service">
                        <div class="default_title">
                            ...
                            <div class="default_tite_right">
                                <p><b>Year 1 A Level Chemistry Topics
(Also suitable for AS students)</b></p>
                                    <br>
                                <p><b>Physical Chemistry</b></p><br>
                ...
                <div class="col-md-6">
                    <div class="our_service">
                        <div class="default_title">
                            ...
                            <div class="default_tite_right">
                                <p><b>Year 2 A Level Chemistry Topics (Also covers the Year 1 A Level topics above)</b></p><br>
                                <p>Organic Chemistry Topics</p>  <br>
                                <p>Carbonyl compounds, Aldehydes and Ketones</p>
                                <br>
                                <p>Carboxylic acids and Esters</p>
                                <br>
                                <p>Amines, Amides and Amino acids</p>
                                <br>
                                <p>Polymers</p>
                                   <br>
                                <p>Organic synthesis</p>
                                  <br>
                                <p>Chromatography and spectroscopy (NMR)</p>
                                <div class="dtr_img"><img
                                        src="{{ asset('frontend/update-design') }}/assets/images/home/default-title-right.png"
                                        alt=""></div>
                            </div>
                    ...
                    <div class="our_service">
                        <div class="default_title">
                            ...
                            <div class="default_tite_right">
                                <p><b>Year 2 A Level Chemistry Topics (Also covers the Year 1 A Level topics above)</b></p><br>
                                <p>Inorganic Chemistry Topics</p>  <br>
                                <p>Transition elements</p>
                                <br>
                                <p>Reactions of ion solutions</p>
                            ...
                            <div class="what_make_us_single">
                                ...
                                <div class="what_make_us_single_text">
                                    ...
                                    <p>The aim of our courses is to build on the learners existing knowledge and develop
                                        ...
                                        understanding of what Chemistry examiners are looking for in papers. Your
                                        child will
