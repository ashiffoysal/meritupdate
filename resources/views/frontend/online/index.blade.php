...
@section('title', 'Online Tutoring in the UK – Live KS1 to A-Level Tuition | Merit Tutors')
@section('meta_description','Access expert online tutoring for KS1 to A-Level students in the UK. Merit Tutors delivers live, interactive lessons with real tutors – anytime, anywhere.')
@section('content')
                        ...
                        <div class="banner_section">
                            <div class="banner_left">
                                <div class="banner_left_contents">
                                	<span class="banner_span">Online Tutoring</span>
                                    <h2>Welcome <span>to <img src="{{ asset('frontend/update-design') }}/assets/images/home/for-shape.png" alt=""></span> <br>Merit Tutors</h2>
