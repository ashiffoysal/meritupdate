...
@section('title', 'On-Site Tutoring in East London – Trusted KS1 to A Level Tuition | Merit Tutors')
@section('meta_description','Join our trusted East London tuition centres for on-site tutoring from KS1 to A Level. Merit Tutors offers personalised support in a focused learning environment.')
@section('content')
                        ...
                        <div class="banner_section">
                            <div class="banner_left">
                                <div class="banner_left_contents">
                                	<span class="banner_span">On-site Tutoring</span>
                                    <h1>Personalised <span> On-Site <img src="{{ asset('frontend/update-design') }}/assets/images/home/for-shape.png" alt=""></span> <br> Tutoring at Our East London Centres</h1>
                                    ...
                                    <div class="banner_contents_btns">
                                        <a href="#" class="btn_style">Book a Free Assessment</a>
                                    </div>
                                </div>
                            </div>
