                                    ...
                                    @foreach($alldata as $key => $data)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">TUTOR</a>
                                            </td>
                                            
                                           
                                           <td>
                                               @if($data->full_watch_video==1)
                                               <span class="badge badge-success">All Watched Videos</span>
                                               @else
                                                <span class="badge badge-danger">Not Completed Watched</span>
                                               @endif
                                               
                                           </td>
                                           <td>
                                               <a href="{{ url('admin/watch-video/tutor/list/'.$data->id) }}">
                                                   View Details
                                               </a>
                                           </td>
                                        </tr>
