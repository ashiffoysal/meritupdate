...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="{{ url('admin/tutorial-video/create') }}" class="btn btn-sm btn-primary">Create Video</a>
                            </div>
                        </div>
    ...
    border-radius: 10px;
        ...
        <div class="row g-4">
            <!-- Total Users -->
            <div class="col-md-4">
                <a href="{{ url('admin/video-category/1') }}">
    ...
    ->count();
            ...
            <!-- New Orders -->
            <div class="col-md-4">
                 <a href="{{ url('admin/video-category/2') }}">
                <div class="card dashboard-card">
                    <div class="card-body d-flex align-items-center">
                        <div class="card-icon bg-success me-3">
                            <i class="bi bi-cart" style="color: #ffffff;font-size: 2rem;"></i>
                        </div>
                        <div>
                            @php
    ...
    ->count();
            ...
            <!-- Revenue -->
            <div class="col-md-4">
                <a href="{{ url('admin/video-category/3') }}">
                <div class="card dashboard-card">
                    <div class="card-body d-flex align-items-center">
                        <div class="card-icon bg-warning me-3">
                            <i class="bi bi-cash-stack" style="color: #ffffff;font-size: 2rem;"></i>
                        </div>
                        <div>
                            @php
