          ...
          <div class="content-wrapper">
            <!-- Content -->
               ...
               <!--start-->
                <!---->
                 <div class="card mt-2">
                    <h5 class="card-header">Proof Of Address</h5>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12" id="image_section">
                                                           ...
                                                           <div class="col-md-12" style="display:none" id="pdf_section">
                                                            <div class="form-group">
                                                                <div class="mb-3">
                                                                    <label for="exampleFormControlInput1" class="form-label" style="font-weight: 700;">Uploads Proof Of Address (pdf):<span style="color:red">*</span></label>
                                                                    <div class="form-group">
