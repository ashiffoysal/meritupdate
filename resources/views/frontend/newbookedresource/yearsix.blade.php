...
<html lang="en">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
         ...
         <title>Year 6 Workbooks | {{ $companyInformation->company_name }}  </title>
                    ...
                    <div class="col-md-12">
                        <div class="header">
                            ...
                            <div class="header_btn">
                                <a href="{{ url('workbooks-checkout/6') }}">
                                    Order Now
                    ...
                    <div class="col-md-12">
                        <div class="banner">
                            <div class="banner_contents">
                                <h1><span>Primary Year 3 Maths Activity Workbook :</span> For 10-11 Years Old Child (KS2)</h1>
                                <p>This Year 6 Maths workbook 1 is the perfect practice material for 10-11 year olds to develop and solidly the basic mathematical skills they need in Year 3.</p>
                                <a href="{{ url('workbooks-checkout/6') }}" class="btn_style">
                                    <span>£ 15</span>
                                    Order Now
                            ...
                            <div class="banner_img">
                                <img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/CoverMockupYear6Book1.webp" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="why_choose_us">
                            ...
                            <div class="why_choose_us_contents">
                                <div class="why_choose_us_single">
                                    <div class="why_choose_us_single_img"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/why-us-1.png" alt=""></div>
                                ...
                                <div class="why_choose_us_single">
                                    <div class="why_choose_us_single_img"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/why-us-2.png" alt=""></div>
                                ...
                                <div class="why_choose_us_single">
                                    <div class="why_choose_us_single_img"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/why-us-3.png" alt=""></div>
                        ...
                        <div class="preview_section">
                                ...
                                <div class="tab-content preview_tab_contents" id="pills-tabContent">
                                        ...
                                        <div class="preview_tabs_carousel">
                                            <div class="book-slider">
                                                <div class="book-container">
                                                    <div class="book active"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/CoverMockupYear6Book1.webp" alt="Page 1"></div>
                                                       <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book1/contentspage.png" alt="Page 5"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book1/Image-1.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book1/Image-2.png" alt="Page 2"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book1/Image-3.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book1/Image-4.png" alt="Page 4"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book1/Image-5.png" alt="Page 5"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book1/Image-6.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book1/Image-7.png" alt="Page 4"></div>
                                    ...
                                    <div class="tab-pane fade" id="wordbook2" role="tabpanel" aria-labelledby="wordbook2-tab">
                                        <div class="preview_tabs_carousel">
                                            <div class="book-slider">
                                               <div class="book-container">
                                                    <div class="book active"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book2/CoverMockupYear6Book2.webp" alt="Page 1"></div>
                                                       <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book2/contentspage.png" alt="Page 5"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book2/Image-1.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book2/Image-2.png" alt="Page 2"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book2/Image-3.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book2/Image-4.png" alt="Page 4"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book2/Image-5.png" alt="Page 5"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book2/Image-6.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book2/Image-7.png" alt="Page 4"></div>
                                    ...
                                    <div class="tab-pane fade" id="wordbook3" role="tabpanel" aria-labelledby="wordbook3-tab">
                                         <div class="preview_tabs_carousel">
                                            <div class="book-slider">
                                            <div class="book-container">
                                                    <div class="book active"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book3/CoverMockupYear6Book3.webp" alt="Page 1"></div>
                                                       <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book3/contentspage.png" alt="Page 5"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book3/Image-1.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book3/Image-2.png" alt="Page 2"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book3/Image-3.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book3/Image-4.png" alt="Page 4"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book3/Image-5.png" alt="Page 5"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book3/Image-6.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book3/Image-7.png" alt="Page 4"></div>
                                    ...
                                    <div class="tab-pane fade" id="wordbook4" role="tabpanel" aria-labelledby="wordbook4-tab">
                                         <div class="preview_tabs_carousel">
                                            <div class="book-slider">
                                            <div class="book-container">
                                                    <div class="book active"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book4/CoverMockupYear6Book4.webp" alt="Page 1"></div>
                                                       <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book4/contentspage.png" alt="Page 5"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book4/Image-1.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book4/Image-2.png" alt="Page 2"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book4/Image-3.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book4/Image-4.png" alt="Page 4"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book4/Image-5.png" alt="Page 5"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book4/Image-6.png" alt="Page 3"></div>
                                                    <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/book4/Image-7.png" alt="Page 4"></div>
                                    ...
                                    <div class="tab-pane fade" id="wordbook5" role="tabpanel" aria-labelledby="wordbook5-tab">
                                        <div class="preview_tabs_carousel">
                                            <div class="book-slider">
                                                <div class="book-container">
                                                    <div class="book active"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/answerbooks/1.webp" alt="Page 1"></div>
                                                       
                                                  <div class="book"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/answerbooks/4.jpg" alt="Page 4"></div>
                                                </div>
                                                <button class="prev"><i class="fa fa-arrow-left"></i></button>
                                                <button class="next"><i class="fa fa-arrow-right"></i></button>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="wordbook6" role="tabpanel" aria-labelledby="wordbook6-tab">
                                        <div class="preview_tabs_carousel">
                                            <div class="book-slider">
                                                <div class="book-container">
                                                    <div class="book active"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/answerbooks/2.webp" alt="Page 1"></div>
                                    ...
                                    <div class="tab-pane fade" id="wordbook7" role="tabpanel" aria-labelledby="wordbook7-tab">
                                        <div class="preview_tabs_carousel">
                                            <div class="book-slider">
                                                <div class="book-container">
                                                    <div class="book active"><img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/answerbooks/3.webp" alt="Page 1"></div>
                            ...
                            <div class="preview_single_section" id="benefits">
                                <div class="preview_single_section_contents">
                                    <div class="pssc_contents">
                                        <p class="p_border">This Year 6 Maths workbook is the perfect practice material</p>
                                        <h3>For 10-11 year olds to develop and solidly the basic mathematical skills they need in Year 6.</h3>
                                ...
                                <div class="preview_single_section_img">
                                    <img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/workbooks.webp" alt="">
                                    <div class="psci_content_box">
                                        <ul>
                                            <li>
                                                <h4>10-11 <b>Years</b></h4>
                                                <p>Reading Age</p>
                                            </li>
                                            <li><span></span></li>
                                            <li>
                            ...
                            <div class="preview_single_section preview_single_section2">
                                <div class="preview_single_section_img pscimg2">
                                    <img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/AboutMeritTutorsYear6.webp
" alt="">
                                </div>
                                <div class="preview_single_section_contents">
                                    <div class="pssc_contents">
                    ...
                    <div class="col-md-12">
                        <div class="order_now">
                            <div class="default_title order_now_title">
                                <span>Order Now</span>
                                <h3>Unlock Your Child’s Full Potential with Year 6 Maths Workbooks</h3>
                                    ...
                                    <div class="tab-pane fade show active" id="package" role="tabpanel" aria-labelledby="package-tab">
                                        <div class="order_now_contents">
                                            <div class="order_now_contents_img">
                                                <img src="{{ asset('frontend/bookedresource') }}/assets/images/yearsix/ComboPackYear6.webp" alt="">
                                            </div>
                                            <div class="order_now_contents_right">
                                                <div class="pssc_contents">
                                                    <h3>This pack includes everything you need to support your child's learning throughout the entire Year 6 Maths curriculum.</h3>
                        ...
                        <div class="testimonials">
                            ...
                            <div class="testimonials_carousel owl-carousel owl-theme owl-loaded">
                                <div class="testimonials_single">
                                    <p>Outstanding workbook—fun, engaging, and packed with 200+ curriculum-based exercises and visuals!</p>
                                    <div class="testimonials_single_profile">
                                        <div class="testimonials_profile_left">
                                            ...
                                            <p>Kamrul Chowdhury <span>Teacher</span></p>
                                        </div>
                                        <span><a href="#"><img src="{{ asset('frontend/bookedresource') }}/assets/images/sales-page/facebook.png" alt=""></a></span>
                                    </div>
                                </div>
                                <div class="testimonials_single">
                                    <p>Great Year 6 follow-up—engaging, challenging, and perfect for SATs prep and confidence-building!
</p>
                                    <div class="testimonials_single_profile">
                                        <div class="testimonials_profile_left">
                                            <!--<span><img src="{{ asset('frontend/bookedresource') }}/assets/images/sales-page/profile3.png" alt=""></span>-->
                                            <p>Emily <span>Parent</span></p>
                                        </div>
                                        <span><a href="#"><img src="{{ asset('frontend/bookedresource') }}/assets/images/sales-page/whatsapp.png" alt=""></a></span>
                                    </div>
                                </div>
                                <div class="testimonials_single">
                                    <p>Exceptional Year 6 workbook—200+ pages of curriculum-aligned practice that builds skills, confidence, and understanding!
</p>
                                    <div class="testimonials_single_profile">
                                        <div class="testimonials_profile_left">
                                            <!--<span><img src="{{ asset('frontend/bookedresource') }}/assets/images/sales-page/profile2.png" alt=""></span>-->
                                            <p>Saidur<span>Teacher</span></p>
                                        </div>
                                        <span><a href="#"><img src="{{ asset('frontend/bookedresource') }}/assets/images/sales-page/facebook.png" alt=""></a></span>
                                    </div>
                                </div>
                                <div class="testimonials_single">
                                    <p>Must-have for Year 6—targeted, well-structured, and great for boosting understanding and confidence!
</p>
                                    <div class="testimonials_single_profile">
                                        <div class="testimonials_profile_left">
                                            <!--<span><img src="{{ asset('frontend/bookedresource') }}/assets/images/sales-page/profile1.png" alt=""></span>-->
                                            <p>Rebecca  <span>Parent</span></p>
                                        </div>
                                        <span><a href="#"><img src="{{ asset('frontend/bookedresource') }}/assets/images/sales-page/whatsapp.png" alt=""></a></span>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="order_now_bottom">
                            <div class="default_title order_now_title2">
                                <span>ORDER NOW</span>
                                <h3>Primary Year 6 Maths Activity Workbook</h3>
                                <p>For 10-11 Years Old Child (KS2)</p>
                                <a href="{{ url('workbooks-checkout/6') }}" class="btn_style">
                                    <span>£ 50</span>
                                    Order Now
                                    <svg width="39" height="38" viewBox="0 0 39 38" fill="none" xmlns="http://www.w3.org/2000/svg">
