...
@section('title', 'A-Level Biology Revision Courses – Expert Tutors in East London')
@section('meta_description', 'Prepare for A-Level Biology success with expert tutors in East London. Boost grades with focused revision courses. Book your spot at Merit Tutors today!')
@section('content')
                    ...
                    <div class="banner_section">
                        <div class="banner_left">
                            <div class="banner_left_contents">
                                <span class="banner_span">A Level Biology Revision Course</span>
                                <h1 class="myTitle">A Level Biology Booster <span> Course </span> <br>– Targeted
                                    Revision to Maximise Exam Success</h1>
                                <p>At Merit Tutors, we understand the importance A Level exam results play when it comes to university applications. We aim to challenge our pupils to ensure they are confident and prepared to achieve their potential in their exams. A Level content can be difficult to understand, therefore our tutors take the time to understand each child’s needs, adapting their teaching styles and strategies to ensure our students get the most out of their lessons.
                                </p>
                                <p>Our A Level Biology revision course is designed for Year 12 and Year 13 pupils preparing for A Level Biology exam.
Our revision courses are made up of an intimate study group, normally with 4-6 students from the same year group. Our A Level groups consist of AS and A2 learners, allowing the AS students to learn advanced techniques early and be ahead of their peers, while simultaneously allowing our A2 pupils to significantly improve their knowledge and technique for their exams.</p>
                    ...
                    <div class="our_service">
                        <div class="default_title">
                            <div class="default_title_left">
                                <h2>A Level <span>Biology Topics <img
                    ...
                    <div class="our_service">
                        <div class="default_title">
                            ...
                            <div class="default_tite_right">
                                <p><b>Year 1 A Level Biology Topics(Also suitable for AS students)</b></p>
                                <p>Cells and Molecules (e.g. proteins, mitosis, enzymes, membranes)</p><br>
                                <p>Disease (e.g. viruses, heart disease)</p>
                                <br>
                                <p>Human Systems (e.g. blood circulation, respiratory system)</p>
                                <br>
                                <p>Plant Biology (e.g. phloem detail, plant transport)</p>
                                <br>
                                <p>Evolution, DNA and Ecosystems (e.g. biodiversity, selection and evolution)</p>
                ...
                <div class="col-md-6">
                    <div class="our_service">
                        <div class="default_title">
                            ...
                            <div class="default_tite_right">
                                    <p><b>Year 2 A Level Biology Topics 
(Also covers the Year 1 A Level topics above)</b></p>
                                <p>Cells and Molecules (e.g. mutation, stem cells)</p>
                                <br>
                                <p>Disease (e.g. cancer, antibiotics, bacterial growth)</p>
                                <br>
                                <p>Human systems (e.g. hormones, nervous system)</p>
                                <br>
                                <p>Plant biology (e.g. ecosystems, phytochromes)</p>
                                <br><p>Evolution, DNA and Ecosystems (e.g. ecosystems, genetic engineering)</p>
                                <br>
                                <p>Energy (e.g. respiration, photosynthesis)</p>
                                <br>
                            ...
                            <div class="what_make_us_single">
                                ...
                                <div class="what_make_us_single_text">
                                    ...
                                    <p>The aim of our courses is to build on the learners existing knowledge and develop
                                        ...
                                        understanding of what Biology examiners are looking for in papers. Your
                                        child will
