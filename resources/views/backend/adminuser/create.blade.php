    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <!--end::Header-->
                <!--begin::Form-->
                <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.admin-user.create') }}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Body-->
                    <div class="card-body" data-select2-id="select2-data-90-elj6">
                        <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                            <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            ...
                                            <input class="form-control form-control-solid" type="text" name="name" value="" placeholder="Enter Name" required>
                                        </div>
                                        @error('name')
                                   ...
                                   <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            ...
                                            <input class="form-control form-control-solid" type="text" name="username" value="" placeholder="Enter username" required>
                                        </div>
                                        @error('username')
                                            <div class="validation">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Password:<span class="validation">*</span></label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input type="hidden" name="id" value="">
                                            <input class="form-control form-control-solid" type="password" name="password" value="" placeholder="Enter password" required>
                                        </div>
                                        @error('username')
                                            <div class="validation">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="email" name="email" value="" placeholder="Enter Email" required>
                                        </div>
                                        @error('email')
                                            <div class="validation">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" value="" name="phone" placeholder="Enter Phone" required>
                                        </div>
                                        @error('meta_keyword')
                                            <div class="validation">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <textarea class="form-control form-control-solid" type="text" name="address" placeholder="Enter Address"></textarea>
                                        </div>
                                    ...
                                    <label class="col-lg-3 col-form-label text-lg-end">User Category:</label>
                                        <div class="col-lg-9 col-xl-4">
                                          ...
                                          <div class="form-check form-switch">
                                                  <input class="form-check-input" type="checkbox" name="user_category[]" id="{{ $cateGory->id }}" value="{{ $cateGory->id }}">
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <!--begin::Checkbox-->
                                                            <label class="form-check form-check-custom form-check-solid me-10">
                                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="assesment" value="1" checked="checked">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <label class="form-check form-check-custom form-check-solid">
                                                            <input class="form-check-input h-20px w-20px" type="checkbox" name="tutor" value="1">
                                            ...
                                            <div class="offset-3 col-lg-9 col-xl-4 row">
                                                    <div class="col-md-6">
                                                        <div class="d-flex align-items-center">
                                                            <!--begin::Checkbox-->
                                                            <label class="form-check form-check-custom form-check-solid me-10">
                                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="student_request" value="1" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Checkbox-->
                                                            <label class="form-check form-check-custom form-check-solid">
                                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="student" value="1">
                                               ...
                                               <div class="offset-3 col-lg-9 col-xl-4 row">
                                                    ...
                                                    <div class="col-md-6">
                                                          <div class="d-flex align-items-center">
                                                            ...
                                                            <label class="form-check form-check-custom form-check-solid">
                                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="fees" value="1">
