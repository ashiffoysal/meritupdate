                        ...
                        <div class="banner_section">
                            <div class="banner_left">
                                <div class="banner_left_contents">
                                    ...
                                    <h1>Welcome <span>to <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/for-shape.png" alt=""></span> <br>Merit Tutors</h1>
                            ...
                            <div class="banner_right">
                                <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/about/1.webp" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="our_service">
                            <div class="default_title">
                                <div class="default_title_left">
                                    <h2>Let’s <span>hear Our <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/text-pos.png" alt=""></span><img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/default-title-left.png" alt=""><br>Story</h2>
                                </div>
                            ...
                            <div class="our_enjoyable_course_top_contents">
                                <div class="oectc_single">
                                    <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/about/icon1.png" alt="">
                                    <h4>Established in<br>2004</h4>
                                    <p>Merit Tutors has supported students across London for over 15 years</p>
                                </div>
                                <div class="oectc_single">
                                    <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/about/icon2.png" alt="">
                                    <h4>Consistent exam success</h4>
                                    <p>100% of our GCSE and A-Level students achieved A-B grades in 2021</p>
                                </div>
                                <div class="oectc_single">
                                    <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/about/icon3.png" alt="">
                    ...
                    <div class="col-md-12">
                        <div class="what_make_us">
                            <div class="default_title_2nd">
                                <h2>What Makes<span> Us <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/text-pos2.png" alt=""></span> Different?</h2>
                            </div>
                            <div class="what_make_us_contents">
                                <div class="what_make_us_single">
                                    <div class="what_make_us_single_img">
                                        <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/about/22.webp" alt="">
                                    </div>
                                    <div class="what_make_us_single_text">
                                        ...
                                        <div class="wmust_img"><img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/default-title-right.png" alt=""></div>
                                    </div>
                                </div>
                                <div class="what_make_us_single">
                                    <div class="what_make_us_single_text">
                                        ...
                                        <div class="wmust_img"><img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/default-title-different.png" alt=""></div>
                                    </div>
                                    <div class="what_make_us_single_img">
                                        <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/about/3.webp" alt="">
                                    </div>
                                </div>
                                <div class="what_make_us_single">
                                    <div class="what_make_us_single_img">
                                        <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/about/4.webp" alt="">
                                    </div>
                                    <div class="what_make_us_single_text">
                                ...
                                <div class="what_make_us_single">
                                    ...
                                    <div class="what_make_us_single_img">
                                        <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/about/5.webp" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="default_title default_title2 default_title3">
                            <div class="default_title_left">
                                <h2>Merit <span>Tutors <img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/text-pos2.png" alt=""></span><img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/default-title-left2.png" alt=""> <br>Pricing & Fees</h2>
                            </div>
                            <div class="default_tite_right">
                                ...
                                <div class="dtr_img"><img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/default-title-right3.png" alt=""></div>
                            </div>
                        </div>
                        <div class="clilds_progress mt-2">
                            ...
                            <div class="clilds_progress_contents">
                                <div class="clilds_progress_contents_left">
                                    ...
                                    <div class="clilds_progress_contents_left_img"><img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/about/6.webp" alt=""></div>
                                </div>
                                ...
                                <div class="clilds_progress_contents_arrow"><a href="{{ url('/online-tutoring') }}"><img class="lazy" data-src="{{ asset('frontend/update-design') }}/assets/images/home/cpc-btn-icon.png" alt=""></a></div>
