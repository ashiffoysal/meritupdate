...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    @php
    $allSubject = DB::table('tutoring_subjects')->where('is_deleted', 0)->where('status', 1)->get();
    @endphp
                                    ...
                                    <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Video Category:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                   <select name="user_category" class="form-select form-select-solid">
                                                       <option selected disabled>Select</option>
                                                       @php
