        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Tutor-Create</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            ...
            <div class="card">
                ...
                <!--end::Header-->
                <!--begin::Form-->
                <form class="form" method="POST" id="kt_layout_builder_form" action="{{ url('admin/tutor/create') }}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Body-->
                        ...
                        <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                            <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            ...
                                            <input class="form-control form-control-solid" type="text" name="name" placeholder="Enter Name" required value="{{ old('name') }}">
                                        </div>
                                        @error('name')
                                  ...
                                  <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="email" name="email" placeholder="Enter Email" required value="{{ old('email') }}">
                                        </div>
                                        @error('email')
                                            <div class="validation">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            ...
                                            <input class="form-control form-control-solid" type="text" name="password"  placeholder="Enter password" value="123456" required>
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" name="phone" placeholder="Enter Phone" required value="{{ old('phone') }}">
                                        </div>
                                        @error('phone')
                                            <div class="validation">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Tutor Type:<span class="validation">*</span></label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <select class="form-select form-control-solid" name="tutor_type">
                                                <option value="Branch Tutor">Branch Tutor</option>
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <textarea class="form-control form-control-solid" type="text" name="address" placeholder="Enter Address"> {{ old('address') }}</textarea>
                                        </div>
                                        @error('address')
                                            <div class="validation">{{ $message }}</div>
                                        @enderror
