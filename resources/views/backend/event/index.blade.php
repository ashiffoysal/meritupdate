        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Events Manage</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="{{ url('admin/event/create') }}" class="btn btn-sm btn-primary">Create Events</a>
                            </div>
                        </div>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:14px" >
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{  Carbon\Carbon::parse($data->date)->format('d-F-Y') }}</a>
                                            </td>
                                            <td>
                                                <a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->start_time  }}</a>
                                            </td>
                                            <td>
                                                <a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->address  }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="{{url('admin/event/edit/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fas fa-pen-square blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('/admin/event/delete/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
