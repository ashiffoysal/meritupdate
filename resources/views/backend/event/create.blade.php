        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Create Event</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                                ...
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="title" placeholder="Event Title" value="{{old('title')}}">
                                                </div>
                                                @error('title')
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="date" name="date" placeholder="Event Date" value="{{old('date')}}">
                                                </div>
                                                @error('date')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="time" name="start_time" placeholder="Event Start Time" value="{{old('start_time')}}">
                                                </div>
                                                @error('start_time')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="time" name="end_time" placeholder="Event End Time" value="{{old('end_time')}}">
                                                </div>
                                                @error('end_time')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input name="price" class="form-control form-control-solid" type="text" placeholder="Event Price" value="{{old('price')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input name="slot" class="form-control form-control-solid" type="text" placeholder="Event Slot" value="{{old('slot')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    ...
                                                    <textarea name="address"  class="form-control form-control-solid" placeholder="Event Address">{{old('address')}}</textarea>
                                                </div>
                                                @error('address')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <!-- <input name="slot" class="form-control form-control-solid" type="text" placeholder="Event Slot"> -->
                                                    <textarea name="google_map"  class="form-control form-control-solid" placeholder="Event Google Map">{{old('google_map')}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea id="summernote" st class="form-control form-control-solid" name="details" placeholder="Event Details" >{{old('details')}}</textarea>
                                                </div>
                                                @error('details')
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input name="tags" id="tags" data-role="tagsinput" class="form-control form-control-solid tags" type="text" placeholder="Tags">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
