...
@section('title', 'Resources update')
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Resources Update</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Resources Update</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            <div class="card">
                <form action="{{ url('admin/resources/update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <!-- radio ends -->
                    <div class="row">
                            ...
                            <div class="card-body">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Title:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="title" placeholder="Enter Title" value="{{ $data->title }}">
                                                    <input type="hidden" name="id" placeholder="Enter Title" value="{{ $data->id }}">
                                                </div>
                                                @error('Title')
                                         ...
                                         <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">SKU:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="sku" placeholder="Enter SKU" value="{{ $data->sku }}">
                                                </div>
                                                @error('SKU')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                         ...
                                         <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Price:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="price" placeholder="Enter Price" value="{{ $data->price }}">
                                                </div>
                                                @error('price')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                         ...
                                         <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <select class="form-control form-control-solid" type="text"  id="category" name="category_id">
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">SubCategory:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <select class="form-control form-control-solid" type="text" id="subcategory" name="subcategory_id">
                                                         <option selected disabled>Select</option>
                                                         @php
                                                            $allSubCategory=DB::table('subcategories')->where('category_id',$data->category_id)->get();
                                                         @endphp
                                                        @foreach($allSubCategory as $SubCategory)
                                                        <option value="{{ $SubCategory->id }}" @if($data->subcategory_id==$SubCategory->id) selected  @endif>{{ $SubCategory->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                @error('Title')
                                          ...
                                          <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Levels:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <select class="form-control form-control-solid" type="text" name="levels">
                                                         <option selected disabled>Select</option>
                                                        @foreach($allLevels as $levels)
                                                        <option value="{{ $levels->id }}" @if($levels->id==$data->levels) selected @endif> {{ $levels->level_name }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                @error('Title')
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea id="summernote" class="form-control form-control-solid" type="text" name="description" placeholder="Enter Description"> {{ $data->description }}</textarea>
                                                </div>
                                                @error('description')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Purchase Link:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea class="form-control form-control-solid" type="text" name="purchase_link" placeholder="Enter Purchase Link">{{ $data->purchase_link }}</textarea>
                                                </div>
                                                @error('description')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                           ...
                                           <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input name="tags" id="tags" data-role="tagsinput" class="form-control form-control-solid tags" type="text" placeholder="Tag" value="{{ $data->tags }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">PDF Preview(10 page):<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="file" name="pdf">
                                                </div>
                                                @error('description')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                          ...
                                          <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">PDF File:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <embed
    src="{{ asset('updatecore/public/'.$data->pdf) }}"
                                                ...
                                                <div id="editimage" class="col-xl-12 col-md-12 col-sm-12 col-xs-12 spartan_item_wrapper" data-spartanindexrow="0" style="margin-bottom : 20px; ">
                                                    <div style="position: relative;">
                                                        ...
                                                        <label class="file_upload" style="width: 100%; height: 450px; border: 2px dashed #ddd; border-radius: 3px; cursor: pointer; text-align: center; overflow: hidden; padding: 5px; margin-top: 5px; margin-bottom : 5px; position : relative; display: flex; align-items: center; margin: auto; justify-content: center; flex-direction: column;">
                                                            ...
                                                            <img style="width: 100%; margin: 0px auto; vertical-align: middle; display: ;" data-spartanindexi="0" src="{{asset('updatecore/public/'.$data->thumbnail_image)}}">
