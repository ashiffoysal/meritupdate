...
@section('title', 'Add Tuition Resources')
@section('content')
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Uploads Tuition Resources</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            <div class="card">
                <form action="{{ url('admin/tuition-reources-create') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <!-- radio ends -->
                    <div class="row">
                                ...
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="title" placeholder=" Title" vlaue="{{old('product_sku')}}">
                                                </div>
                                                @error('title')
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    ...
                                                    <select name="category_id" id="category_id" class="form-control form-control-solid">
                                                        ...
                                                        @foreach($allSubcate as $categoty)
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <label class="col-lg-3 col-form-label text-lg-end">Main File:<span class="required"></span></label>
