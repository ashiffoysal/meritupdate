    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Event</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Event</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event Title:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="title" placeholder="Event Title" value="{{$edit->title}}">
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event Date:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="date" name="date" placeholder="Event Date" value="{{$edit->date}}">
                                                </div>
                                                @error('date')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event Start Time:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="time" name="start_time" placeholder="Event Start Time" value="{{$edit->start_time}}">
                                                </div>
                                                @error('start_time')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event End Time:<span class=""></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="time" name="end_time" placeholder="Event End Time" value="{{$edit->end_time}}">
                                                </div>
                                                @error('end_time')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event Price:<span class=""></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input name="price" class="form-control form-control-solid" type="text" placeholder="Event Price" value="{{$edit->price}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event Slot:<span class=""></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input name="slot" class="form-control form-control-solid" type="text" placeholder="Event Slot" value="{{$edit->total_slot}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event Address:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <!-- <input name="slot" class="form-control form-control-solid" type="text" placeholder="Event Slot"> -->
                                                    <textarea name="address"  class="form-control form-control-solid" placeholder="Event Address">{{$edit->address}}</textarea>
                                                </div>
                                                @error('address')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event Google Map:<span class=""></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <!-- <input name="slot" class="form-control form-control-solid" type="text" placeholder="Event Slot"> -->
                                                    <textarea name="google_map" class="form-control form-control-solid" placeholder="Event Google Map">{{$edit->google_map}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event Details:<span class="required"></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea id="summernote" st class="form-control form-control-solid" name="details" placeholder="Event Details" >{{$edit->details}}</textarea>
                                                </div>
                                                @error('details')
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Event Tags:<span class=""></span></label>
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input name="tags" id="tags" data-role="tagsinput" class="form-control form-control-solid tags" type="text" placeholder="Tags" value="{{ $edit->tags}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
