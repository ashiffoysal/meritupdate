<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="{{url('/admin')}}" class="d-lg-none">
									...
									<img alt="a" src="{{asset('uploads/adminimage/'.$companyInformation->logo)}}" style="height:60px !important;" />
                                    @else
                                    <img alt="Logao" src="{{asset('backend')}}/assets/media/logos/logo-compact.svg" style="height:60px !important;" />
                                    @endif
								</a>
							</div>
							<!--end::Mobile logo-->
					...
					@endphp
											<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{route('admin.assesment.index')}}">
													<span class="menu-title">Assesment</span><span class="badge badge-success">{{ $assesmentall }}</span>
												</a>
											</div>
											@endif
											@php
											$studentrequ=App\Models\StudentTutorRequest::where('is_approve',0)->where('is_deleted',0)->count();
											@endphp
											@if(Auth::user()->student_request==1)
											<div class="menu-item me-lg-1">
												<a class="menu-link" href="{{route('admin.student-request.index')}}">
													<span class="menu-title">Student Request</span> <span class="badge badge-success">{{ $studentrequ }}</span>
												</a>
											</div>
											@endif

											<div class="menu-item me-lg-1">
												<a class="menu-link" target="__blanck" href="{{url('/')}}">
