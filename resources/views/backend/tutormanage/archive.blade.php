                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Archive Tutor</span>
			...
			@endphp
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                <a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->code }}</a>
                                            </td>
                                            <td>
                                                    ...
                                                    <td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                                            ...
                                                            <div class="menu-item px-3">
																...
																<div class="menu-item px-3">
																<a href="{{url('/admin/removearchive/tutor/'.$data->id)}}" class="menu-link px-3">Remove(Archive)</a>
															</div>
                                                            <div class="menu-item px-3">
