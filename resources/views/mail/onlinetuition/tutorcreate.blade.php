    ...
    >
      ...
      <tr>
        <td>
          ...
          <p style="margin: 20px 0; color: #333; font-size: 15px; font-weight: 400">
            We hope you're doing well. We're following up regarding the training videos in your Merit Tutors account. Despite prior reminders, we’ve noticed that some tutors have yet to complete all the required videos. These tutorials have been specifically designed to enhance your teaching methods, engage your students more effectively, and maximize your use of our resources.
          </p>

          <p style="margin: 0; color: #333; font-size: 15px; font-weight: 400">
            <strong>Please ensure the training videos are completed by the end of this week.</strong>
          </p>

          <p style="margin: 20px 0; color: #333; font-size: 15px; font-weight: 400">
            We understand that you have a busy schedule, but completing this training is essential for providing high-quality tutoring sessions. If you’ve encountered any issues accessing or completing the videos, don’t hesitate to get in touch. We are here to assist you.
          </p>

          <h3 style="font-size: 16px; font-weight: 600; margin: 20px 0 10px 0; color: #247e3d;">How to Access Your Training Videos:</h3>
          <ul style="margin: 0 0 20px 20px; padding: 0; color: #333; font-size: 15px;">
            <li>⿡ Log in to your Merit Tutors account: <a href="https://www.merittutors.co.uk/login" style="color:#247e3d; text-decoration: underline;">Log In Here</a></li>
            <li>⿢ Select your subjects: <a href="#" style="color:#247e3d; text-decoration: underline;">Select Subjects</a></li>
            <li>⿣ Watch the training videos: <a href="#" style="color:#247e3d; text-decoration: underline;">Watch Videos</a></li>
          </ul>
          ...
          <p style="margin: 20px 0; color: #333; font-size: 15px; font-weight: 400">
            We truly appreciate your commitment to improving the learning experience for your students. Completing these videos will help you develop your skills and ensure you're fully prepared for your upcoming tutoring sessions.
          </p>

          <p style="margin: 20px 0; text-align: center;">
            <a
              class="hoverbtn"
              href="https://drive.google.com/drive/folders/1F6hMmtX0KkbLlzfFWkhmVmKWaIyOkrah?usp=sharing"
              style="
      ...
      <tr>
        <td>
          <p style="color: #333; font-size: 15px; font-weight: 400; margin: 0;">
            Best Regards,
          </p>
          <p
            class="paddingBottom"
        ...
        <td style="text-align: center; font-size: 12px; color: #888; padding: 0px">
          ...
          <tr>
            <td style="text-align: center; padding: 0px">
              ...
              <img style="width: 6px; margin: 0 1.5px" src="https://i.postimg.cc/xjFb40tn/dots.png" alt="dots" />
              <a href="https://www.merittutors.co.uk/terms-condition" style="color: #333333; font-size: 11px; text-decoration: underline; font-weight: 400;">Terms of service</a>
              <img style="width: 6px; margin: 0 1.5px" src="https://i.postimg.cc/xjFb40tn/dots.png" alt="dots" />
              <a href="https://www.merittutors.co.uk/contact" style="color: #333333; font-size: 11px; text-decoration: underline; font-weight: 400;">Help center</a>
            </td>
          </tr>
        </td>
      </tr>
