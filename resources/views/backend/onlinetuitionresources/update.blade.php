...
@section('title', 'Update Tuition Resources')
@section('content')
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Tuition Resources</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            <div class="card">
              <form action="{{ route('admin.tuition-resources-update') }}" method="POST" enctype="multipart/form-data">
  @csrf
  <div class="row">
          ...
          <div class="card-body">
              <div class="tab-content pt-3">
                  <div class="tab-pane active" id="kt_builder_main">
                      ...
                      <div class="row mb-10">
                          ...
                          <div class="col-lg-9 col-xl-7">
                              <select name="category_id" id="category_id" class="form-control form-control-solid">
                                  ...
                                  @foreach($allSubcate as $category)
                                      <option value="{{ $category->id }}" @if($edit->category_id == $category->id) selected @endif>
                                          {{ $category->name }}
                                      </option>
                                  @endforeach
                              </select>
                      ...
                      <div class="row mb-10">
                          <label class="col-lg-3 col-form-label text-lg-end">Main File:</label>
                          <div class="col-lg-9 col-xl-7">
                              <input type="file" name="file" accept=".pdf">
                              <p>File Size: 10mb</p>
                              <a class="badge badge-danger" href="{{ asset('uploads/tuition_resources/'.$edit->file) }}" target="_blank">Check</a>
                          </div>
                          @error('file')
