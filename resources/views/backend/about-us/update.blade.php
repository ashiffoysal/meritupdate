                            ...
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            <label class="col-lg-2 col-form-label text-lg-end">Title:</label>
                                            <div class="col-lg-9 col-xl-8">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="title" placeholder="Title" value="{{ $data->title }}">
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-8">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                <textarea id="summernote"  name="details" class="details" height="160px">{{ $data->details }}</textarea>
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-2 col-form-label text-lg-end">Image:</label>
                                            <div class="col-lg-9 col-xl-4">
            
                                                <!--begin::Image input-->
                                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(assets/media/avatars/blank.png)">
                                                    <!--begin::Preview existing avatar-->
                                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{asset('uploads/aboutus/'.$data->image)}})"></div>
