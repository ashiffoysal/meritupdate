					...
					<div class="card card-flush">
						...
						<div class="card-body pt-5" id="kt_chat_contacts_body">
							...
							<div class="scroll-y me-n5 pe-5 h-200px h-lg-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_chat_contacts_header" data-kt-scroll-wrappers="#kt_content, #kt_chat_contacts_body" data-kt-scroll-offset="0px">
								...
								@php
								    $main=App\Models\NotifyChat::where('user_id',$user->id)->latest()->first();
								@endphp
								@if($main)
								<div class="d-flex flex-stack py-4">
									...
									<div class="d-flex align-items-center">
										...
										<div class="symbol symbol-45px symbol-circle">
										    @if($user->photo==null)
											<img alt="Pic" src="{{asset('uploads/dummy-image.jpg')}}"/>
											@else
									...
									<!--begin::Lat seen-->
									@php
									$countnotification=App\Models\NotifyChat::where('user_id',$user->id)->where('admin_is_seen',0)->count();
									@endphp
									<div class="d-flex flex-column align-items-end ms-2">
										<span class="text-muted fs-7 mb-1"></span>
										<span class="badge badge-sm badge-circle badge-light-danger">{{ $countnotification }}</span>
									</div>
									<!--end::Lat seen-->
								</div>
								@endif
					...
					<div class="card" id="kt_chat_messenger">
											...
											<div class="d-flex flex-column align-items-end">
												...
												<div class="d-flex align-items-center mb-2">
													...
													<div class="me-3">
														...
														<a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-primary ms-1">Merit Tutors</a>
													</div>
													<!--end::Details-->
													<!--begin::Avatar-->
												...
												<!--end::User-->
												<!--begin::Text-->
												<div class="p-5 rounded bg-light-primary text-dark fw-bold mw-lg-400px" data-kt-element="message-text">{!! $message->message !!}</div>
												<!--end::Text-->
											</div>
											<!--end::Wrapper-->
										</div>
											...
											<div class="d-flex align-items-center mb-2">
												...
												<div class="ms-3">
													<a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-primary me-1">
													    @php
													        $nameuser_message=App\Models\User::where('id',$message->user_id)->select(['name'])->first();
													    @endphp
													    {{ $nameuser_message->name }}</a>
													<span class="text-muted fs-7 mb-1">{{ $message->created_at }}</span>
												</div>
												<!--end::Details-->
											</div>
						...
						<div class="card-footer pt-4" id="kt_chat_messenger_footer">
							...
							<form action="{{ url('/admin/user/notify/'.$data->id) }}" method="post">
								@csrf
							<textarea class="form-control form-control-flush mb-3" required id="summernote" name="message" rows="1"  placeholder="Type a message"></textarea>
