                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:14px" >
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            <td> {{ ++$key }} </td>
                                            <td>
                                                <a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->first_name }} {{ $data->last_name }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $data->position }}</a>
                                            </td>
                                            <td>
                                                <a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">  {{ date('d-m-Y', strtotime($data->created_at));}} </a>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <a href="{{url('/admin/apply-candidate/details/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <i class="fas fa-eye blue"></i>
                                                </a>
                                                <a id="delete" href="{{url('/admin/apply-candidate/delete/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
