                        ...
                        <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                            <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="text" name="google_verification" placeholder="Google Verification" value="{{$edit->google_verification}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="text" name="bing_verification" placeholder="Bing Verification" value="{{$edit->bing_verification}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <textarea class="form-control form-control-solid" type="text" name="google_analytics" placeholder="Google Analytics">{{$edit->google_analytics}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <textarea class="form-control form-control-solid" type="text" name="alexa_analytics" placeholder="Alexa Analytics">{{$edit->alexa_analytics}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
