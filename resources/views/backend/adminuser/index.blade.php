                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="{{ url('admin/admin-user/create') }}" class="btn btn-sm btn-primary">Create Admin-User</a>
                            </div>
                        </div>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:14px" >
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->phone }}</td>
                                            @php
                                            	$role_name=App\Models\Role::where('id',$data->role)->first();
                                            @endphp
                                            <td>@if($role_name) {{ $role_name->name }} @endif</td>
                                            <td class="text-end">
                                                
                                                 <a href="{{url('/admin/watch-recored-for-admin/index/'.$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
