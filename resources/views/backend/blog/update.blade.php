                                    ...
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        ...
                                        <div class="row mb-10">
                                          ...
                                          <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="meta_title" placeholder="Blog Meta Title" vlaue="{{ $edit->meta_title }}" required>
                                                </div>
                                                @error('meta_title')
                                                <div style="color:red">{{ $message }}</div>
                                                @enderror
                                         ...
                                         <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="meta_description" placeholder="Blog Meta Description" vlaue="{{ $edit->meta_description }}" required>
                                                </div>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-7">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea id="myeditor" st class="form-control form-control-solid" name="description" placeholder="Product Description" >{{ $edit->description }}</textarea>
                                                </div>
                                            </div>
                                            @error('description')
