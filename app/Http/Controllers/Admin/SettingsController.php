...
class SettingsController extends Controller
{
    ...
    public function subscriveall(){
        $alldata=DB::table('subscription')->orderBy('id','DESC')->get();
        return view('backend.subscriver.index', compact('alldata'));
    
    }
     public function deletesubscriv($id){
        $delete=DB::table('subscription')->where('id',$id)->delete();
      if ($delete) {
            $notification = array(
