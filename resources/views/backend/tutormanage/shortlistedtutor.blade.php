                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%;font-size:14px" >
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">Short List </th>
                        			...
                        			@php
                        			    $inditotalverification=App\Models\VerificationCenter::where('user_id',$data->id)->where('is_verify',0)->count();
                        			    $inditotaltutoreducation=App\Models\TutorEducation::where('user_id',$data->id)->where('is_verify',0)->count();
                        			...
                        			@endphp
                                        <tr>
                                            ...
                                            <td>
                                                {{ $data->name }}
                                                @if($inditotalverification + $inditotaltutoreducation >0)
                                                <span class="badge badge-light-danger">{{ $inditotalverification + $inditotaltutoreducation }}</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge badge-success">Short listed</span>
                                                @else
                                                    ...
                                                    <td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true" style="">
															...
															<div class="menu-item px-3">
															  ...
															  <div class="menu-item">
																<a href="{{url('/admin/tutor/removeshortlisted/'.$data->id)}}" class="menu-link px-3">Remove shortlist</a>
															</div>
                                                            ...
                                                            <div class="menu-item px-3">
															 ...
															 <div class="menu-item px-3">
																<a href="{{ url('/admin/archive/tutor/'.$data->id) }}" class="menu-link px-3">Add Archive</a>
															</div>
                                                            <div class="menu-item px-3">
