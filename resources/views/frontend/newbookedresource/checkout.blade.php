...
@enderror
												    ...
												    <label class="book-option">
												        ...
												        <div class="book-details">
												            ...
												            <ul>
												                ...
												                <li><span><img src="{{ asset('frontend/bookedresource') }}/assets/images/checkout/check.png" alt=""></span> Answer Book for all 4 Workbooks</li>
												                <li><span><img src="{{ asset('frontend/bookedresource') }}/assets/images/checkout/check.png" alt=""></span> Test Book to assess progress</li>
												                <li><span><img src="{{ asset('frontend/bookedresource') }}/assets/images/checkout/check.png" alt=""></span> Test Answer Sheets</li>
												            </ul>
												        </div>
							      ...
							      @elseif($id==6) Year 6 @endif Workbook 4 <b>£15</b></label>
																 ...
																 <div class="pick_choose_checkbox">
																    <input type="checkbox" id="cb5" class="paccheckbox" name="resource_details[]" value="Answer Book">
																    <label for="cb5">Answer Book   <b>£10</b></label>
																</div>
																
																	 <div class="pick_choose_checkbox">
																    <input type="checkbox" id="cb6" class="paccheckbox" name="resource_details[]" value="Test Book">
																    <label for="cb6">Test Book   <b>£10</b></label>
																</div>
																
																
																	 <div class="pick_choose_checkbox">
																    <input type="checkbox" id="cb7" class="paccheckbox" name="resource_details[]" value="Test Answers">
...
$(document).ready(function() {
    function calculateTotal() {
        ...
        const isCombo = $("input[name='resource_type'][value='combo']").prop('checked');
        const isIndividual = $("input[name='resource_type'][value='individual']").prop('checked');
        const selectedWorkbooks = $("input[name='resource_details[]']:checked");
        ...
        if (isCombo) {
            ...
            if (selectedWorkbooks.length > 0) {
                ...
                selectedWorkbooks.each(function() {
                    let val = $(this).next('label').text().toLowerCase();

                    if (val.includes('workbook')) {
                        total += 15;
                    } else if (
                        val.includes('answer book') || 
                        val.includes('test book') || 
                        val.includes('test answers')
                    ) {
                        total += 10;
                    } else {
                        // Default price if needed, or 0
                    }
                });
