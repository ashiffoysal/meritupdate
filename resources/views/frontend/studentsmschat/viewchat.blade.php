                 ...
                 <div class="card mt-1">
                    <h5 class="card-header">Chat</h5>
                                <div class="row " style="margin:0px 0px">
                                    <div class="col-md-2">
                                    <a href="{{ url('/student/message') }}" class="btn-sm btn-success">Back</a>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                         <div class="row">
                            @php
                       $user_name_image=App\Models\User::where('id',$id)->select(['name','photo'])->first(); 
                       @endphp
                                                        ...
                                                        @foreach($allsms as $sms)
                                                            @if($sms->type=='outgoing')
                                                                <div class="msg left-msg">
                                                                    <div
                                                                    class="msg-img"
                                                                    style="background-image: url({{ asset('/'.$user_name_image->photo) }})"
                                                                    ></div>

                                                                    <div class="msg-bubble">
                                                                        <div class="msg-info">
                                                                        <!-- <div class="msg-info-name">BOT</div> -->
                                                                        <div class="msg-info-time">{{ $user_name_image->name }}<br>
                                                                            {{ $sms->created_at }}</div>
                                                                        </div>
