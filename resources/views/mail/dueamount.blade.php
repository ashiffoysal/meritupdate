...
<center class="wrapper">
    <table class="top-panel center" width="602" border="0" cellspacing="0" cellpadding="0">
        <tbody>
        <tr>
            <td class="title" width="300">Merit Tutors</td>
            <td class="subject" width="300"><a class="strong" href="#" target="_blank">info@merittutors.co.uk</a></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="column">
                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="padded">
                          <h1>Due Amount Notice:</h1>
                 
                          
                          <p>Please Pay Due amount and continue your lessons.</p>
        ...
        <tr>
            <td class="signature" width="300">
                <p>
                   ...
                   Merit Tutors<br>
                    0208 616 2526 (FOREST GATE)<br>
020 8478 9988 (ILFORD)<br>
                    </p>
                <p>
                    Support: <a class="strong" href="mailto:#" target="_blank">info@merittutors.co.uk</a>
                </p>
            </td>
            <td class="subscription" width="600">
