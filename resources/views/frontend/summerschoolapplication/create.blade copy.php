...
@section('title', 'Summer School Application')
@section('content')
<style>
    .apply-form {
                ...
                <div class="d-table-cell">
                    <div class="container">
                        <div class="page-banner-content">
                            <h2 style="color:#fff !important;">SUMMER SCHOOL</h2>
                            <ul>
                                <li>
                                    <a href="{{ url('/') }}">HOME</a>
                                </li>
                                <li>SUMMER SCHOOL FORM</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!-- Your form fields -->
                        <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="branch" class="form-control" id="">
                                            ...
                                            <option value="2">ILFORD LANE</option>
                                             <option value="3">PLAISTOW BRANCH</option>
                                        </select>
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Choose your Application Type </label>
                                     
                                        <select name="application_type" class="form-control" id="">
                                            <option value="SUMMER SCHOOL">SUMMER SCHOOL</option>
                                            <option value="MATHS COMPETITION">MATHS COMPETITION</option>
